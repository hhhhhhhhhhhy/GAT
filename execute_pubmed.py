...
# 预训练模型的文件路径
checkpt_file = 'pre_trained/pubmed/mod_pubmed.ckpt'
...
with tf.Graph().as_default():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(nb_epochs):
            ...
            # 打印训练和验证的结果
            print('Training: loss = %.5f, acc = %.5f | Val: loss = %.5f, acc = %.5f, time = %.5f' %
        ...
        # 打印测试结果
        print('Test loss:', ts_loss/ts_step, '; Test accuracy:', ts_acc/ts_step, '; test time:', time.time()-test_start)
